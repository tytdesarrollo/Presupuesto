USE [presama]
GO
/****** Object:  StoredProcedure [dbo].[SP_INSERT_ADICION]    Script Date: 12/10/2017 16:25:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_INSERT_ADICION] 
(
...
AS
	...
	WHILE patindex('%,%' , @IN_NUM_DOCU) <> 0
		BEGIN
			...
			VALUES 
			(@MODA,@COD_FUERZA,'CONSORCIO SAMA','ADI_ING',@VIG,@FEC_MOV,@NUM_DOCU,@V_MPRMOVLIN,@COD_ESM,
