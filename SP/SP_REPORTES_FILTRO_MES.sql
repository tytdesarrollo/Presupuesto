...
AS
	...
	IF(ISNULL(OBJECT_ID('tempdb..##TablaReporte2'), 0) <> 0 AND ISNULL(OBJECT_ID('tempdb..##TablaReporte2s'), 0))	
		BEGIN
		...
		-- CONSULTA CONSOLIDADO VIGENCIA
			...
			EXECUTE sp_executesql @QUERY, @PARAMS, @NOMBRES_TEMP1 = @NOMBRES_TEMP1, @ADI_ING = @ADI_ING, @RED_ING = @RED_ING, @PRE_ING = @PRE_ING,
								  @AUT_PAG = @AUT_PAG, @IN_FECHA_INI =  @IN_FECHA_INI, @IN_FECHA_FIN = @IN_FECHA_FIN, @IN_MODALIDAD = @IN_MODALIDAD,
