...
class SpInsertAutPagos extends Model{	

	
    public function procedimiento($c1,$c2,$c3,$c4,$c5,$c6,$c7,$c8,$c9,$c10)
    {
		...
		$IN_AMORTI = $c9;//'8888888,7777777';
		$IN_MES_FACT = $c10;//'4,4';

		$rows = Yii::$app->telmovil->createCommand("EXEC SP_INSERT_AUTPAGOS @IN_NUM_DOCU = :IN_NUM_DOCU,
        ...
        $rows->bindParam(":IN_AMORTI", $IN_AMORTI, PDO::PARAM_STR);
        $rows->bindParam(":IN_MES_FACT", $IN_MES_FACT, PDO::PARAM_STR); 
